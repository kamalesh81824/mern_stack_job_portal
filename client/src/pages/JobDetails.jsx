...
import { BiBriefcase, BiBuildings, BiDollar, BiRupee } from 'react-icons/bi'
              ...
              <div className='md:px-12 pl-4'>
                ...
                <div>
                  <ul className='flex flex-col gap-3'>
                    ...
                    <li className='flex items-center gap-3'>Salary: <div className='flex items-center' ><BiDollar />  <span>{(jobDetails.salary  / 100000).toFixed(0)} 000</span></div></li>
